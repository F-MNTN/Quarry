...
These are my personal study notes, I use [obsidian](https://obsidian.md/)  to organize them for myself, but that makes them extremely difficult to share via `theentiretyofmyknowledge.pdf` or similar file formats since obsidian-links are at the core of this *~~organisation~~*-style. So here is a website with fuzzy finding.
