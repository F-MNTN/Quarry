...
## Mitose - Zellteilung
Zellen entstehen aus Zellen. [Zellteilung oder Mitose](https://de.wikipedia.org/wiki/Mitose) ist der Prozess der Vermehrung einer Zelle.  Dabei werden mehrere Phasen durchgangen: ![[Pasted image 20260702131640.png]]
[Source](https://de.wikipedia.org/wiki/Datei:Schemazeichnung_Mitose.svg)
Zellen sind thermodynamisch offene Systeme und Tauschen somit Energie und Material mit ihrer Umgebung aus. 

## Kompartimente
Zellen teilen sich in räumlich und chemisch getrennte Elemente auf, in denen sich höhere Konzentrationen der Reagenzien befinden.
Diese [Organellen](https://de.wikipedia.org/wiki/Organell) spezialisieren sich auf ihre Aufgabe und können von anderen Organellen als "Black box" beobachtet werden die zusammen Teil eines größeren Prozesses sind.
...
![[Pasted image 20260702131121.png|Float:right]]
[Source](https://en.wikipedia.org/wiki/File:Prokaryote_cell.svg)
Sind Bestandteil von Bakterien und Arachaeen.
...
| -------------------- | --------------------------------------------------- | ---------------------------------------- |
| [[#Nucleus]]         | Vorhanden                                           | Nicht vorhanden                          |
| Speicherort der DNA  | im [[#Nucleus]]                                     | im [[#Zytoplasma]]                       |
| Speicherform der DNA | doppelsträngige [[Chromosomen]]                     | ringförmige [[Chromosomen]] und Plasmide |
